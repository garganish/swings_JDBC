...
public class thirdframe extends javax.swing.JFrame {
    ...
    public thirdframe() {
        ...
        maps=utility.getCourseSubjects();
        jcbcourse.removeAllItems();
        jcbcourse.addItem("Choose the subjects");
        Set<String> keys=maps.keySet();//WE USE SET SO 2 REMOVE THE DUPLICATE SUBJECTS
        for(String key:keys)
        {
            jcbcourse.addItem(key.toString());
        }
        //DefaultListModel items=new DefaultListModel(); //THIS IS USED TO CLEAR THE ITEMS IN THE LIST
       // list.setModel(items);
    ...
    private void initComponents() {
        ...
        jcbcourse.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        ...
        list.setFont(new java.awt.Font("Lucida Bright", 2, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jcbcourse, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jcbcourse, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jcbcourseItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbcourseItemStateChanged
        ...
        {
            List<String> lt=maps.get(jcbcourse.getSelectedItem().toString());
            if(lt!=null)
            {
                for(String subjects:lt)
                {
                    items.addElement(subjects);
                }
            }
        }
        list.setModel(items);
